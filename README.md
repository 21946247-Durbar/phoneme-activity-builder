...
- **30 words** with 3 phonemes (e.g., _bed_ → b-e-d)
- **30 words** with 4 phonemes (e.g., _stop_ → s-t-ɔ-p)
- **30 words** with 5 phonemes (e.g., _stamp_ → s-t-æ-m-p)
...
- **Harrington, J., & Cox, F.** (2008). _The acoustic characteristics of Australian English vowels_. Journal of Phonetics, 36(2), 328-344. [https://doi.org/10.1016/j.wocn.2007.09.002](https://doi.org/10.1016/j.wocn.2007.09.002)
- **Moats, L.** (2020). _Speech to print: Language essentials for teachers_ (3rd ed.). Paul H. Brookes Publishing.
- **W3C Web Accessibility Initiative.** (2023). _Web Content Accessibility Guidelines (WCAG) 2.1_. [https://www.w3.org/TR/WCAG21/](https://www.w3.org/TR/WCAG21/)
- **React Documentation.** (2024). _React: The library for web and native user interfaces_. [https://react.dev/](https://react.dev/)
- **Tailwind CSS Documentation.** (2024). _Tailwind CSS: Utility-first CSS framework_. [https://tailwindcss.com/](https://tailwindcss.com/)
